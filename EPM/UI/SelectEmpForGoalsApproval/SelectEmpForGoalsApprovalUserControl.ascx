...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SelectEmpForGoalsApprovalUserControl.ascx.cs" Inherits="EPM.UI.SelectEmpForGoalsApproval.SelectEmpForGoalsApprovalUserControl" %>

<SharePoint:CssRegistration runat="server" Name="/_layouts/15/EPM/EPMStyle.css" After="/Style%20Library/css/ShareBoot.css" />
<SharePoint:CssRegistration runat="server" Name="/_layouts/15/EPM/SelectEmpForGoalsApproval.css"  />
...
<asp:GridView ID="gvwSelectEmp" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <HeaderStyle Width="20%" />
         ...
         <asp:BoundField HeaderText="حالة الأهداف" DataField="Emp_Application_Status" >
        <HeaderStyle Width="30%" />
        </asp:BoundField>
        
        <asp:CommandField ButtonType="Button" HeaderStyle-Width="10%" SelectText="اعتماد الأهداف" ShowSelectButton="True" ShowHeader="True" >
